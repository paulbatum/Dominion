...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Play Witch with only 1 Curse left", new string[] {
                        "Ignore"});
#line 12
this.ScenarioSetup(scenarioInfo);
#line 13
testRunner.Given("A new game with 3 players");
#line 14
testRunner.But("There is only 1 Curse left");
#line 15
testRunner.And("Player1 has a Witch in hand instead of a Copper");
#line 16
testRunner.When("Player1 plays a Witch");
